 ...
 */
export type { DetectOptions, DetectionReport, ProviderCapability, ProviderSource, ProviderTier, RecommendMode, } from './types.ts';
export { DEFAULT_DEEPSEEK_API_KEY_ENV, DEFAULT_OLLAMA_BASE_URL, detect, detectDeepSeek, detectOllama, } from './detect.ts';
