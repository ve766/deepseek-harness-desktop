...
import knowledgeRemote from '@deepseek-ai/dsh-knowledge-indexer/remote'
...
export type {} from '@deepseek-ai/dsh-knowledge-indexer/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, knowledgeRemote,
    ]) {
